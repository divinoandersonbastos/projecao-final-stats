      ...
      try {
        ...
        if (pdfData.home && pdfData.away) {
          setHomeTeam({
            ...
            dangerousAttacksAgainst: pdfData.home.attacksAgainst || 0,
            cornersFor: pdfData.home.corners || 0,
            cornersAgainst: pdfData.home.cornersAgainst || 0,
            shotsFor: pdfData.home.shots || 0,
            shotsAgainst: pdfData.home.shotsAgainst || 0,
            shotsOnTargetFor: pdfData.home.shotsOnTarget || 0,
            shotsOnTargetAgainst: pdfData.home.shotsOnTargetAgainst || 0,
          ...
          setAwayTeam({
            ...
            dangerousAttacksAgainst: pdfData.away.attacksAgainst || 0,
            cornersFor: pdfData.away.corners || 0,
            cornersAgainst: pdfData.away.cornersAgainst || 0,
            shotsFor: pdfData.away.shots || 0,
            shotsAgainst: pdfData.away.shotsAgainst || 0,
            shotsOnTargetFor: pdfData.away.shotsOnTarget || 0,
            shotsOnTargetAgainst: pdfData.away.shotsOnTargetAgainst || 0,
